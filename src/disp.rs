...
impl Display for message::RequestFileTransferReq {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "RequestFileTransferReq(mode_of_operation={:?}, \
            path_name={}, compression_method=0x{:x}, encryption_method=0x{:x}, \
...
impl Display for message::RequestFileTransferRsp {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        write!(
            ...
            file_dir_data_size_bytes={}, file_size_uncompressed={}, \
            ...
            self.file_dir_size_uncompressed,
            self.file_size_compressed
        )
    }
}
