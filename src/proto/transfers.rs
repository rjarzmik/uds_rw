...
pub struct RequestFileTransferRsp {
    ...
    /// Encryption method (oem specific)
    pub encryption_method: u8,
    /// Size in byte for the parameters `file_dir_size_uncompressed` and `file_size_compressed`
    pub file_dir_data_size_bytes: u16,
    /// Size in byte of the uncompressed file to be uploaded
    pub file_dir_size_uncompressed: usize,
